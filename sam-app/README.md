...
exports.handler = async (event) => {
    return "concatenateEcho: " + event.arguments.msg + " : " + event.prev.result;
};
...
exports.handler = async function (event, context) {
    return "echo: " + event.arguments.msg;
  };
...
/* Amplify Params - DO NOT EDIT
	ENV
	REGION
	STORAGE_MESSAGENCOLY7GESJBDNMMBKRHDU53YLADEV_ARN
	STORAGE_MESSAGENCOLY7GESJBDNMMBKRHDU53YLADEV_NAME
	STORAGE_MESSAGENCOLY7GESJBDNMMBKRHDU53YLADEV_STREAMARN
Amplify Params - DO NOT EDIT */
...
exports.handler = async (event) => {
    ...
    if (!tableName) {
        console.error("TableName environment variable is not set.");
        throw new Error("TableName environment variable is not set.");
    }
